...
# Function to compute data for yearly airline performance report
...
# Function to compute data for yearly airline delay report
...
app.layout = html.Div(children=[
    html.Div(className="container", children=[
        html.H1('US Domestic Airline Flights Performance.', style={'textAlign': 'center', 'color': '#007bff', 'font-size': '24px'}),
        html.Div([
            html.Div([
        ...
        html.Div(id='plot1', className='plot'),
        html.Div([
            html.Div(id='plot2', className='plot'),
            html.Div(id='plot3', className='plot')
        ], style={'display': 'flex'}),
        html.Div([
            html.Div(id='plot4', className='plot'),
            html.Div(id='plot5', className='plot')
        ], style={'display': 'flex'}),
    ])
])
...
with open('dash_app.html', 'w') as file:
    file.write(app.to_html())
with open('standalone_dash_app.html', 'w') as file:
